...
var Model = function () {
  ...
  _createClass(Model, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                _context.next = 9;
                return this.saveTemporaryRelations();
    ...
    value: function () {
      ...
      function saveTemporaryRelations() {
        return _ref2.apply(this, arguments);
      }

      return saveTemporaryRelations;
    }()
    ...
    get: function get() {
      ...
      this.schema.forEach(function (column) {
        if (!_this2.columnTypes.includes(column.type)) {
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                return _context5.abrupt('return', new Promise(function (res, rej) {
                  setTimeout(function () {
                    _this4.find(key).then(res).catch(rej);
                  }, 100);
                }));

              case 2:
                return _context5.abrupt('return', new Promise(function (res, rej) {
                  nSQL(_this4.table).query('select').where([_this4.keyAttribute, '=', key]).exec().then(function (result, db) {
                    var model = new _this4(result[0]);
                    res(model);
                  });
                }));
